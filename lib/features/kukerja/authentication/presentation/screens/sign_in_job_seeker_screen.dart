...
class SignInJobSeekerScreen extends StatefulWidget {
  static const String route = "job-seeker";

  const SignInJobSeekerScreen({Key? key}) : super(key: key);

  @override
  State<SignInJobSeekerScreen> createState() => _SignInJobSeekerScreenState();
}

class _SignInJobSeekerScreenState extends State<SignInJobSeekerScreen> {
                        ...
                        child: Column(
                          ...
                          children: [
                            const Heading2(
                              ...
                              text: "Yuk bergabung sebagai Pencari Kerja",
                            ),
                      ...
                      Expanded(
                          ...
                          child: Column(
                            children: [
                              ...
                              SecondaryTextButton(
                                  text: "Daftar disini",
                                  onPressed: () => QR.to("/registration/job-seeker"))
                            ],
                          ))
                    ],
                  ),
