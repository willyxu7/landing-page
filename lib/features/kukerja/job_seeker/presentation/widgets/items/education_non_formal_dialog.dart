...
class _EducationNonFormalDialogState extends State<EducationNonFormalDialog> {
            ...
            child: Column(
              ...
              children: [
                ...
                SimpleOutlinedDropdownSearch(
                  items: _jobSeekerProvider.education.courses,
  ...
  void _saveEducationNonFormal() {
    ...
    _jobSeekerProvider.addEducationNonFormal = request;
  }
  ...
  void _updateEducationNonFormal() {
    ...
    _jobSeekerProvider.updateEducationNonFormal(widget.indexWidget!, request);
  }
