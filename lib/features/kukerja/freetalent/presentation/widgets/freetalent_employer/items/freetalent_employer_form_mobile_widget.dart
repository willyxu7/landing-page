...
import '../../../../../../../core/domain/entities/job_role.dart';
import '../../../../../../../core/providers/job_role_provider.dart';
...
import '../../../../../../../core/widgets/small_loading_icon_button.dart';
import '../../../../data/models/requests/create_freetalent_employer_request.dart';
import '../../../../domain/usecases/freetalent_employer_use_case.dart';
import '../../../providers/freetalent_employer_provider.dart';

class FreetalentEmployerFormMobileWidget extends StatefulWidget {
  ...
  @override
  State<FreetalentEmployerFormMobileWidget> createState() =>
      _FreetalentEmployerFormMobileWidgetState();
}

class _FreetalentEmployerFormMobileWidgetState
    extends State<FreetalentEmployerFormMobileWidget> {
          ...
          child: Column(
            ...
            children: [
              ...
              SimpleOutlinedDropdownSearch<JobRole>(
                  ...
                  itemAsString: (JobRole? jobRole) => jobRole!.labels['id']!,
                ...
                onTap: () async {
                  ...
                  if (selectedDate != null &&
                    ...
                    setState(() {
                      ...
                      widget.workingTimeController.text =
                          DatePickerUtil.convertToIndonesianDateWithWeekday(
