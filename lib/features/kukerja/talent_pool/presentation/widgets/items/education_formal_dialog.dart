...
class EducationFormalDialog extends StatefulWidget {
  ...
  const EducationFormalDialog({this.indexWidget, required this.buildContext, Key? key}) : super(key: key);
...
class _EducationFormalDialogState extends State<EducationFormalDialog> {
  ...
  bool _isShowStudyProgram = true;
  bool _isEndYearOptional = false;
            ...
            child: Column(
              ...
              children: [
                ...
                SimpleOutlinedDropdownSearch(
                    items: context.read<TalentPoolProvider>().educationLevels,
  ...
  List<String> _showStudyProgramsBasedOnSelectedLevel() {
    List<String> studyPrograms =
        context.read<TalentPoolProvider>().education.studyPrograms;

    if (_selectedEducationLevel == "SMK") {
      studyPrograms = context.read<TalentPoolProvider>().education.smk;
    }
  ...
  void _saveEducationFormal() {
    ...
    context.read<TalentPoolProvider>().addEducationFormal =
        educationFormalRequest;
  }
  ...
  void _updateEducationFormal() {
    ...
    context
        ...
        .updateEducationFormal(widget.indexWidget!, request);
  }
